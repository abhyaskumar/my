  ...
  return (
    <div className="w-full">
      ...
      <div
        ...
        style={{ backgroundImage: "url('/Murto.jpg')" }}
      >
        <motion.h1
      ...
      <section className="py-14 px-6 md:px-20 bg-gray-50">
        <div className="max-w-5xl mx-auto">
          <h2 className="text-4xl font-bold text-gray-800 mb-4">About This Branch</h2>
      ...
      <section className="py-14 px-6 md:px-20">
        <h2 className="text-4xl font-bold text-gray-800 mb-8 text-center">Branch Gallery</h2>
      ...
      {/* ------------------ Video Section ------------------ */}
      <section className="py-14 px-6 md:px-20 bg-gray-100">
        <h2 className="text-4xl font-bold text-gray-800 mb-8 text-center">Campus Videos</h2>
      ...
      <section className="py-16 px-6 md:px-20">
        <div className="max-w-4xl mx-auto bg-white shadow-xl rounded-2xl p-10">
          <h2 className="text-4xl font-bold mb-6 text-gray-800">Branch Contact Info</h2>

          <p className="text-lg text-gray-700 mb-2"><strong>📍 Address:</strong> ABC Colony, Near Market Road</p>
          <p className="text-lg text-gray-700 mb-2"><strong>📞 Phone:</strong> +91 9876543210</p>
          <p className="text-lg text-gray-700"><strong>⏰ Timings:</strong> Mon–Sat, 8AM – 2PM</p>
        </div>
      </section>
